    ...
    ({ className, type, ...props }, ref) => {
        ...
        return (
            <Dialog ref={ref} open={isModalOpen} onClose={closeModalMenu} className="relative z-10">
                <DialogBackdrop
                    transition
                    className="fixed inset-0 bg-slate-500/75 transition-opacity data-[closed]:opacity-0 data-[enter]:duration-300 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in"
                />
