            ...
            <div className="w-full">
                <div className="space-y-2">
                    <div className="relative">
                        ...
                        >
                            {isVisible ? (
                                <EyeOff size={16} color="#585656" strokeWidth={2} aria-hidden="true" />
                            ) : (
                                <Eye size={16} color="#585656" strokeWidth={2} aria-hidden="true" />
                            )}
                        </button>
                    </div>
                </div>
                    ...
                    {strength.map((req, index) => (
                        <li key={index} className="flex items-center gap-2">
                            {req.met ? (
                                ...
                                <X size={16} className="text-amber-800" aria-hidden="true" />
                            )}
                            <span className={`text-xs ${req.met ? "text-green-800" : "text-amber-800"}`}>
                                {req.text}
