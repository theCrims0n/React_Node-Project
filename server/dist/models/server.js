...
class Server {
    ...
    middlewares() {
        ...
        this.app.use((0, cors_1.default)({ credentials: true, origin: process.env.NODE_ENV == 'production' ? 'https://react-node-project-1-my5f.onrender.com' : 'http://localhost:3000' }));
